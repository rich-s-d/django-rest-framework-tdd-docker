...
# from movies.views import MovieSerializer, Movie, MovieViewSet
...
#         return {"title": "The Big Lebowski", "genre": "comedy", "year": "1998"}

#     monkeypatch.setattr(MovieViewSet, "retrieve", mock_get_object)
#     monkeypatch.setattr(MovieSerializer, "data", payload)
